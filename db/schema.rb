...
ActiveRecord::Schema[7.0].define(version: 2022_12_12_143607) do
  ...
  create_table "feature_mappings", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["space_id", "feature_id"], name: "index_feature_mappings_on_space_id_and_feature_id", unique: true
